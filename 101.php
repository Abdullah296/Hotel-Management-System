      ...
      <div class="formm" >
         <form action="modified.php?varname=<?php echo $var_value ?>" method = "post" >
            ...
            <div class="form-group">
               ...
               <input type="email" class="form-control" name="Email"   placeholder="Abdullah@gmail.com">
            </div>
            <div class="form-row">
               <div class="form-group col-md-6">
                  <label for="Fromdate">From Date:</label>
                  <input class="w3-input w3-border" class="form-control" name="Fromdate" type="date" id="Fromdate" min="<?php echo date("Y-m-d"); ?>">
               </div>
               <div class="form-group col-md-6">
                  <label for="todate">To Date:</label>
                  <input class="w3-input w3-border" class="form-control" name="todate" type="date" id="todate" min="<?php echo date("Y-m-d"); ?>" >
               </div>
            </div>
            <div class="form-row">
               <div class="form-group col-md-6">
               ...
               <div class="form-group col-md-6">
                  ...
                  <input type="text" class="form-control" id="Child" name="Child" placeholder="1">
               </div>
            </div>
            <div class="form-group">
