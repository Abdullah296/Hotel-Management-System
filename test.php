...
<html lang="en">
   ...
   <body>
      ...
      <?php
      /*
         $to = "abd296@yahoo.com"; // this is your Email address
         $from = "abd290600@gmail.com"; 
         $subject = "Lusail Website Contact Form Submission";
         $message = "New Submission Lusail Contact Form \n\n First Name: ";
         $headers = "From:" . $from;
         ...
         // send email
         //mail("abd290600@gmail.com","My subject",$msg);
         */
...
// Get the modal
        ...
        xhttp.open("GET", "getroom.php?q="+str+"&p="+str1);
        xhttp.send();
        }
        ...
        xhttp.open("GET", "checkroom.php?q="+str+"&p="+str1);
        xhttp.send();
        }
        ...
        xhttp.open("GET", "Cancelreservation.php?q="+str+"&p="+str1);
        xhttp.send();
        }
